...
CREATE SEQUENCE "RAILS"."COMPANY_SEQ" AS INTEGER  START WITH 100 INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 NO CYCLE CACHE 10 NO ORDER;

CREATE SEQUENCE "RAILS"."DCC_SEQ" AS INTEGER  START WITH 100 INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 NO CYCLE CACHE 10 NO ORDER;

CREATE SEQUENCE "RAILS"."IMAGE_SEQ" AS INTEGER  START WITH 100 INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 NO CYCLE CACHE 10 NO ORDER;

CREATE SEQUENCE "RAILS"."MQTT_MSG_SEQ" AS INTEGER  START WITH 100 INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 NO CYCLE CACHE 10 NO ORDER;

CREATE SEQUENCE "RAILS"."PROJECT_ITEM_SEQ" AS INTEGER  START WITH 100 INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 NO CYCLE CACHE 10 NO ORDER;

CREATE SEQUENCE "RAILS"."PROJECT_SEQ" AS INTEGER  START WITH 100 INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 NO CYCLE CACHE 10 NO ORDER;

CREATE SEQUENCE "RAILS"."PURCHASEDITEM_SEQ" AS INTEGER  START WITH 100 INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 NO CYCLE CACHE 10 NO ORDER;

CREATE SEQUENCE "RAILS"."PURCHASE_SEQ" AS INTEGER  START WITH 100 INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 NO CYCLE CACHE 10 NO ORDER;

CREATE SEQUENCE "RAILS"."ROLLINGSTOCK_SEQ" AS INTEGER  START WITH 100 INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 NO CYCLE CACHE 10 NO ORDER;

CREATE SEQUENCE "RAILS"."TURNOUT_SEQ" AS INTEGER  START WITH 100 INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 NO CYCLE CACHE 10 NO ORDER;
...
CREATE TABLE "RAILS"."IMAGE" (
		"IMAGE_ID" INTEGER NOT NULL, 
		"TITLE" VARCHAR(100 OCTETS), 
		"PIC_FILENAME" VARCHAR(100 OCTETS)
	)
	ORGANIZE BY ROW
	DATA CAPTURE NONE 
	IN "USERSPACE1"
...
ALTER TABLE "RAILS"."IMAGE" ADD CONSTRAINT "IMAGE_PK" PRIMARY KEY
	("IMAGE_ID");
...
ALTER TABLE "RAILS"."DCC_ATTRIBUTE" ADD CONSTRAINT "DCC_ATTRIBUTE_ROLLINGSTOCK_FK" FOREIGN KEY
	("RS_ID")
	REFERENCES "RAILS"."ROLLINGSTOCK"
	("RS_ID")
	ON DELETE CASCADE;
...
ALTER TABLE "RAILS"."PROJECT_ITEM" ADD CONSTRAINT "PROJECT_ITEM_ROLLINGSTOCK_FK" FOREIGN KEY
	("RS_ID")
	REFERENCES "RAILS"."ROLLINGSTOCK"
	("RS_ID")
	ON DELETE CASCADE;
...
ALTER TABLE "RAILS"."ROLLINGSTOCK" ADD CONSTRAINT "ROLLINGSTOCK_IMAGE_FK" FOREIGN KEY
	("IMAGE_ID")
	REFERENCES "RAILS"."IMAGE"
	("IMAGE_ID")
	ON DELETE CASCADE;
...
COMMENT ON COLUMN "RAILS"."COMPANY"."CO_ID" IS
'A unique number generated from a sequence to provide a key for this record.';

COMMENT ON COLUMN "RAILS"."DCC_ATTRIBUTE"."DCC_ATTR_ID" IS
'A unique number generated from a sequence to provide a key for this record.';

COMMENT ON COLUMN "RAILS"."DCC_ATTRIBUTE"."RS_ID" IS
'A unique number generated from a sequence to provide a key for this record.';

COMMENT ON COLUMN "RAILS"."IMAGE"."IMAGE_ID" IS
'A unique number generated from a sequence to provide a key for this record.';

COMMENT ON COLUMN "RAILS"."INDUSTRY"."SHORT_NAME" IS
'An abbreviated form identifying an entity conducting business. When that entrprise is an owner or lessees of rolling stock it is the "reporting marks".';

COMMENT ON COLUMN "RAILS"."MQTT_MSG"."ACTION" IS
'An indicator to whether this transaction is a publish or subscribe message.';

COMMENT ON COLUMN "RAILS"."MQTT_MSG"."ACTION_TIME" IS
'The current time when this record is created as a result of a publish or subscribe event.';

COMMENT ON COLUMN "RAILS"."MQTT_MSG"."CONTENT" IS
'The substantive information contained within the MQTT message expressed in JavaScript Object Notation (JSON).';

COMMENT ON COLUMN "RAILS"."MQTT_MSG"."HANDLED_TIME" IS
'The current time when this record has been processed by a RAILS component after the record was created.';

COMMENT ON COLUMN "RAILS"."MQTT_MSG"."MSG_ID" IS
'A unique number generated from a sequence to provide a key for this record.';

COMMENT ON COLUMN "RAILS"."MQTT_MSG"."TOPIC" IS
'A string or filter of a subject, purpose or matter to organize publications and subscriptions. Topic strings are used to send publications to subscribers and topic filters are used to subscribe to topics.';

COMMENT ON COLUMN "RAILS"."PROJECT"."PRJT_ID" IS
'A unique number generated from a sequence to provide a key for this record.';

COMMENT ON COLUMN "RAILS"."PROJECT_ITEM"."PRJT_ITEM_ID" IS
'A unique number generated from a sequence to provide a key for this record.';

COMMENT ON COLUMN "RAILS"."PROJECT_ITEM"."RS_ID" IS
'A unique number generated from a sequence to provide a key for this record.';

COMMENT ON COLUMN "RAILS"."PURCHASE"."PURCHASE_ID" IS
'A unique number generated from a sequence to provide a key for this record.';

COMMENT ON COLUMN "RAILS"."PURCHASE"."VENDOR_ID" IS
'A unique number generated from a sequence to provide a key for this record.';

COMMENT ON COLUMN "RAILS"."PURCHASEDITEM"."MANUFACTURE_ID" IS
'A unique number generated from a sequence to provide a key for this record.';

COMMENT ON COLUMN "RAILS"."PURCHASEDITEM"."UNIT_QTY" IS
'The number of things packaged in a single item acquired. In many cases this will be one for rolling stock.';

COMMENT ON COLUMN "RAILS"."ROLLINGSTOCK"."AVAILABILITY" IS
'The state of the RS as to whether it is able to be used and is at a dispatcher’s disposal for a given session or it is not .';

COMMENT ON COLUMN "RAILS"."ROLLINGSTOCK"."BUILT_BY" IS
'An abbreviated form of identifying an entity conducting business. When that entrprise is a owner or lesssees';

COMMENT ON COLUMN "RAILS"."ROLLINGSTOCK"."IMAGE_ID" IS
'A unique number generated from a sequence to provide a key for this record.';

COMMENT ON COLUMN "RAILS"."ROLLINGSTOCK"."REPORTING_MARKS" IS
'The code of one to four letters used to identify the owners or lessees displayed on the RS.';

COMMENT ON COLUMN "RAILS"."ROLLINGSTOCK"."RFID" IS
'The unique 10 digit number of the Radio Frequency Identification (RFID) tag when read.';

COMMENT ON COLUMN "RAILS"."ROLLINGSTOCK"."RS_ID" IS
'A unique number generated from a sequence to provide a key for this record.';

COMMENT ON COLUMN "RAILS"."TURNOUT"."TURNOUT_ID" IS
'A unique number generated from a sequence to provide a key for this record.';

COMMENT ON TABLE "RAILS"."COMPANY" IS
...
COMMENT ON TABLE "RAILS"."PURCHASE" IS
'A set of acquired items paid for from a specific vendor.';

COMMENT ON TABLE "RAILS"."ROLLINGSTOCK" IS
