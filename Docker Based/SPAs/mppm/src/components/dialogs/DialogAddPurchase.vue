<template>
  <v-card width="800">
    <v-card-title class="headline"> New MR Purchase </v-card-title>
    <v-card-text>
      <v-container>
        <v-row>
    ...
    <v-card-actions>
      <v-spacer></v-spacer>
      <v-btn @click="$emit('closeAddPurchaseDialog')" color="red darken-1" text>
        Cancel
      </v-btn>
      <v-btn :disabled="purchaseAddDataInvalid" @click="addPurchase" text>
        Save
      </v-btn>
    </v-card-actions>
  </v-card>
